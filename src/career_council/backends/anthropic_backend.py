...
from career_council.backends._provider_util import env_key, finished, run_parallel, system_prompt
from career_council.backends.base import Backend, BackendTask
...
class AnthropicBackend(Backend):
    ...
    def check_credentials(self) -> Optional[str]:
        try:
            ...
            return f"anthropic package not installed (`pip install 'career-council-runner[anthropic]'`): {error}"
